...
TARGET_RECOVERY_FSTAB := device/namtso/common/scripts/fstab_tools/recovery_compression.fstab
PRODUCT_FSTAB_TEMPLATE := device/namtso/common/scripts/fstab_tools/fstab_compression.in
#BOARD_USERDATAIMAGE_PARTITION_SIZE := 8589934592
#BOARD_USERDATAIMAGE_PARTITION_SIZE := 26145193984
#PRODUCT_FSTAB_TEMPLATE := device/namtso/rk356x/rk3566_s/fstab_userdata.in
