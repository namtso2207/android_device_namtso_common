...
DEVICE_MANIFEST_FILE += device/namtso/common/manifests/android.hardware.camera.provider@2.4-provider.external.xml
endif

#VIR only
ifeq ($(BOARD_CAMERA_SUPPORT_VIR),true)
DEVICE_MANIFEST_FILE += device/namtso/common/manifests/android.hardware.camera.provider@2.4-provider.virtual.xml
endif
...
DEVICE_MANIFEST_FILE += device/namtso/common/manifests/android.hardware.camera.provider@2.4-provider.external-virtual.xml

# legacy only
else
DEVICE_MANIFEST_FILE += device/namtso/common/manifests/android.hardware.camera.provider@2.4-provider.legacy.xml
endif
...
PRODUCT_COPY_FILES += \
    device/namtso/common/external_camera_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/external_camera_config.xml
endif
...
PRODUCT_COPY_FILES += \
	device/namtso/common/1920x1080.yuv:$(TARGET_COPY_OUT_VENDOR)/etc/camera/1920x1080.yuv
endif
