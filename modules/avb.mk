...
BOARD_AVB_KEY_PATH ?= device/namtso/common/avb_test_keys/testkey_atx_psk.pem
# Only set this when uboot enable security avb.
# BOARD_AVB_METADATA_BIN_PATH ?= device/namtso/common/avb_test_keys/atx_metadata.bin
